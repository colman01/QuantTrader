...
#import "CallableBonds.h"

@implementation CallableBonds
...
-(void) calculate {
    try {
        ...
        std::cout << "Hull White model w/ reversion parameter = 0.03" << endl;
        std::cout << "BAC4.65 09/15/12  ISIN: US06060WBJ36" << endl;
        std::cout << "roughly five year tenor, ";
        cout << "quarterly coupon and call dates" << std::endl;
        std::cout << "reference date is : " << today << endl << endl;
