...
std::vector<Real> values_result,errors_result;
//
//int Bermudan()
//{
//    
...
////            #ifdef __cplusplus
////            dataStore.delta.push_back(values[i]);
////            #endif
////            [delta addObject:[NSNumber numberWithInt:values[r] ]];
//        }
//        
//        
////        NSIntegerVectorToNSArrayOfNSIntegers
////        NSIntegerVectorToNSArrayOfNSIntegers(values);
////         CFShow(NSIntegerVectorToNSArrayOfNSIntegers(values));
//        
////        // declare my vector
...
-(void) calculate {
    ...
    while(!exitCalc) {
        for (int i=5; i < 6; ++i)
            ...
            NSNumber *theI = [NSNumber numberWithInt:i];
//            NSNumber *result = theI/100.0;


            [self newInverseFloater: [NSNumber numberWithInt:100]];
...
-(void) demo {
    ...
    while (![[NSThread currentThread]  isCancelled]) {
        for (int i=5; i < 6; ++i) {
            ...
            [self newInverseFloater:[NSNumber numberWithInt:500]];
//            newInverseFloater([NSNumber numberWithInt:500]);
//            InverseFloater(i/100.0);
        }
    }
}
...
//    for (;;){
//
//        while (![[NSThread currentThread]  isCancelled] || halt) {
//            for (int i=5; i < 10; ++i) {
//                NSLog(@"here in demo");
//
//                if([[NSThread currentThread]  isCancelled]) {
